    ...
    flex flex-col justify-start items-center">
        ...
        <div class="w-[70%] h-[82.5%] flex justify-between items-end  mt-[auto]">
            ...
            text-style2">
                    ...
                    <div v-for="(data, index) in itemList" class="relative w-[600px] h-[76px]
                            flex justify-start items-center pl-4 border-2 border-[#8E7E74]
                            text-style1 text-xs font-semibold bg-bg7 cursor-pointer z-10">
                        {{ data.title }}
                        <span class="absolute right-4 w-[40px] h-[40px]
                            flex justify-center items-center pb-1
                            bg-white border-2 border-[#8E7E74] rounded-full">{{ data.point }}</span>
                    </div>
            ...
            bg-bg9 rounded-t-[25.16px] drop-shadow-shadow2">
                <div class="text-style1 text-base tracking-widers font-notosans-bold">開發Ａ組的短衝辦清單</div>
                <div class="w-full mt-8
                    flex flex-col justify-start items-center gap-y-6">
                    <p class="flex justify-center items-center 
                    text-style1 font-notosans-light">{{ totelPoint }}/20點</p>
